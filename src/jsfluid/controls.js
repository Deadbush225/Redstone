			...
			switch (i) {
				case 0:
					button.onclick = () => {
						...
						this.staticCanvas.style.filter = this.staticFilterToggle
							? ""
							: "none";
						button.style.opacity = this.staticFilterToggle ? "" : 0.3;
						this.values[0].innerText = this.staticFilterToggle
							? "enabled"
							: "disabled";
					};
					break;
				case 1:
					button.onclick = () => {
						...
						this.particlesCanvas.style.filter = this.particlesFilterToggle
							? ""
							: "none";
						button.style.opacity = this.particlesFilterToggle ? "" : 0.3;
						this.values[1].innerText = this.particlesFilterToggle
							? "enabled"
							: "disabled";
					};
					break;
				case 2:
					button.onclick = () => {
						this.timeScaleIndex++;
						if (this.timeScaleIndex >= this.timeScales.length) {
