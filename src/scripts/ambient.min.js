...
export var Ambient = (function () {
	var _customBlur, _retainAttributes;
	function Ambient(options) {
		console.log("CREATING AMBIENT");
		options = options || {};
		this.options = Object.assign(
			{ insertCSS: true, retainAttributes: false, blur: -1 },
			options
		);
	...
	function applyDefaultStyles() {
		var defaultStyles =
			"";
